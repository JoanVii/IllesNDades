...
source("Functions/llegir_px_csv_i_metadades_fast_2.R")
source("Functions/rm_duplicated_data.R")
source("Functions/rm_duplicated_data_2.R")
...
```{r preparar_arxius}
links_to_actualize <- read.csv("Data/links_to_actualize.csv", fileEncoding = "UTF-8")
...
for (i in 1:partitions) {
  ...
  DADES <- llegir.px.csv.i.metadades.fast.2(links_mini)
...
all_metadata_links <- rm.duplicated.data.2(all_metadata_links)
...
key_var <- c("Enllac", "ID", "CONTENTS", "CONTENTS.ca.", "CREATION.DATE", "DESCRIPTION", "DESCRIPTION.ca.", "INFO", "INFO.ca.", "MATRIX", "REFPERIOD", "REFPERIOD.ca.", "SUBJECT.AREA" , "SUBJECT.AREA.ca.", "SUBJECT.CODE", "SURVEY", "SURVEY.ca.", "TITLE", "TITLE.ca.")
